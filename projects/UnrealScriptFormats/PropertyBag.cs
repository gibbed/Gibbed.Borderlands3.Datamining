...
{
    public class PropertyBag : IUnrealSerializable
    {
        public PropertyBag()
        {
            this.UnknownProperties = new Dictionary<PropertyTag, object>();
        }

        public Dictionary<PropertyTag, object> UnknownProperties { get; }
